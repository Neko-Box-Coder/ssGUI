...
int main()
{
    ...
    guiManager.GetBackendInputInterface()->CreateCustomCursor(&img, "custom normal cursor", glm::ivec2(13, 20), glm::ivec2(3, 3));         //Custom cursor
    guiManager.GetBackendInputInterface()->SetCurrentCustomCursor("custom normal cursor") ;         //Custom cursor
