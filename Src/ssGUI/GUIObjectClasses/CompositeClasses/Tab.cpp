...
//TODO(NOW): Finish constructors
namespace ssGUI
{
    glm::vec2 Tab::DefaultCloseButtonSize = glm::vec2(15, 15);
    
    Tab::Tab(Tab const& other) : StandardButton(other)
    {
    }
    ...
    void Tab::InitializeCloseButton()
    {
        ...
        (
            ...
            {
                ssGUI::Tab* tab = info.References->GetObjectReference<ssGUI::Tab>(tabId);
                ...
                ssGUI::Button* closeButton = static_cast<ssGUI::Button*>(info.Container);
                        ...
                        ssGUI::GUIObject* mainWindow)
    {
        ...
        ssGUI::Button* closeButton = (ssGUI::Button*)CurrentObjectsReferences.GetObjectReference(CloseButton);
    ...
    Tab::Tab() :    StandardButton(), 
                    ContentObject(-1)
    {
        //SetBackgroundColor(glm::u8vec4(255, 255, 255, 180));
        
        //TODO(NOW): Create Objects
