...
namespace Backend
{
    ...
    ssGUI::Enums::GenericInput X11InputConverter::ConvertButtonAndKeys(KeySym keysym)
    {
        switch(keysym)
        {
            case XK_F1:
    ...
    ssGUI::Enums::GenericInput X11InputConverter::ConvertMouseButtons(const XEvent& event)
    {
