...
namespace Backend
{
    ...
    ssGUI::Enums::GenericInput Win32InputConverter::ConvertButtonAndKeys(const MSG& msg)
    {
        switch(msg.wParam)
        {
            case VK_F1:
            ...
            case VK_OEM_5:
                if(IsUkLayoutKeyboard())
                    return static_cast<ssGUI::Enums::GenericInput>(ssGUI::Enums::SymbolKey::BACKSLASH_UK);
                else
            ...
            case VK_OEM_7:
                if(IsUkLayoutKeyboard())
                    return static_cast<ssGUI::Enums::GenericInput>(ssGUI::Enums::SymbolKey::HASH_UK);
                else
                    return static_cast<ssGUI::Enums::GenericInput>(ssGUI::Enums::SymbolKey::QUOTE);
            case VK_OEM_COMMA:
            ...
            case VK_DECIMAL:
                return static_cast<ssGUI::Enums::GenericInput>(ssGUI::Enums::SymbolKey::NUMPAD_PERIOD);
            case VK_TAB:
                return static_cast<ssGUI::Enums::GenericInput>(ssGUI::Enums::SystemKey::TAB);
            case VK_CAPITAL:
                return static_cast<ssGUI::Enums::GenericInput>(ssGUI::Enums::SystemKey::CAPS_LOCK);
    ...
    ssGUI::Enums::GenericInput Win32InputConverter::ConvertMouseButtons(const MSG& msg)
    {
        switch(msg.message)
        {
            case WM_LBUTTONDOWN:
