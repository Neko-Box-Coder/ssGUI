#ifndef SSGUI_WINDOW_DRAG_STATE_CHANGED_EVENT_CALLBACK_H
#define SSGUI_WINDOW_DRAG_STATE_CHANGED_EVENT_CALLBACK_H
...
namespace EventCallbacks
{
    ...
    class WindowDragStateChangedEventCallback : public BaseEventCallback
    {
        ...
        public:
            ...
            virtual WindowDragStateChangedEventCallback* Clone(bool copyListeners) override;
